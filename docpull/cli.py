...
def get_config(args: argparse.Namespace) -> FetcherConfig:
    ...
    if hasattr(args, "log_level_shortcut") and args.log_level_shortcut is not None:
        config.log_level = args.log_level_shortcut
    ...
    # Store dry-run flag in config (add to FetcherConfig if needed)
